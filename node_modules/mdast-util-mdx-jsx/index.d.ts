...
import type {Tag} from 'mdast-util-mdx-jsx/lib/index.js'

// Expose JavaScript API.
export {mdxJsxFromMarkdown, mdxJsxToMarkdown} from 'mdast-util-mdx-jsx/lib/index.js'

// Expose options.
export type {ToMarkdownOptions} from 'mdast-util-mdx-jsx/lib/index.js'
