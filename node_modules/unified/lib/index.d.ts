import {CallableInstance} from 'unified/lib/callable-instance.js'
/**
...
export type CompileResultMap = import('unified').CompileResultMap;
export type Data = import('unified').Data;
