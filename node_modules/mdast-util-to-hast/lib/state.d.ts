...
export type FootnoteBackContentTemplate = import('mdast-util-to-hast/lib/footer.js').FootnoteBackContentTemplate;
export type FootnoteBackLabelTemplate = import('mdast-util-to-hast/lib/footer.js').FootnoteBackLabelTemplate;
/**
 * Handle a node.
 */
